	...
	<a class="skip-link screen-reader-text" href="#primary"><?php esc_html_e( 'Skip to content', 'wprig' ); ?></a>
		...
		<?php if ( has_header_image() ) : ?>
			...
			<div class="site-branding">
				<?php the_custom_logo(); ?>
				<div class="site-title-clickable"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"></a>
				</div>
				<div class="site-title">
					<p class="talking">Talking </p><p class="to">to</p><p class="mormons">Mormons</p>
				</div>
			</div><!-- .site-branding -->	
			<?php 
			else: ?>
			<div class="site-branding not-home">
				<div class="site-title-clickable"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"></a>
				</div>
				<div class="site-title">
					<p class="talking">Talking </p><p class="to">to</p><p class="mormons">Mormons</p>
